    ...
    if ( event == 'key_down' ) then
        ...
        elseif ( b == 28 ) then -- Enter
            ...
            elseif ( menu[pos] == 'MineOS EFI' ) then
                ...
                pos = 1
                drawMenu()
            elseif ( menu[pos] == 'EFI' and prevPos == 'MineOS EFI' ) then
            ...
            elseif ( menu[pos] == 'Installer' and prevPos == 'MineOS EFI' ) then
                eeprom.setLabel("MineOS EFI")
